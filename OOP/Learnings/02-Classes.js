...
const car = new Vehicle("BMW", "M5", "blue"); //instances of the class
car.drive();
console.log(car.miles);

//Important note:
//The Classes are NOT hoisted. No matter what, the class keyword will stay where it was written and not move during interpretation.
