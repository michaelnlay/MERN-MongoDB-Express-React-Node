...
function insertFunctional(tableName, columnValuePairs) {
    ...
    const columns = Object.keys(columnValuePairs).join(", ") // ["firstName", "lastName", "age", "isAdmin"]--> ""
    
    const values = Object.values(columnValuePairs).map((value,idx)=>{ //['John', 'Doe', 30, false]
