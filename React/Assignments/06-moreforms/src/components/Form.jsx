    ...
    return (
        ...
        <form className="text-primary">
                <div className="form-group">
                    ...
                    {
                        firstName.length<2?<p className="text-danger">First Name cannot less than two characters!</p>:null
                    }
                </div>
                <div className="form-group">
                    ...
                    {
                        lastName.length < 2 ? <p className="text-danger">Last Name cannot less than two characters!</p> : null
                    }
                </div>
                <div className="form-group">
                    ...
                    {
                        email.length < 5 ? <p className="text-danger">Email cannot less than 5 characters!</p> : null
                    }
                </div>
                <div className="form-group">
                    ...
                    {
                        password.length<5?<p className="text-danger">Password cannot be less than 5 characters!</p>:null
                    }
                </div>
                <div className="form-group">
                    ...
                    {
                        password != Confpassword?<p className="text-danger">Password does not match!</p>:null
                    }
                </div>
